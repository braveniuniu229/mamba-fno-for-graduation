...
from dataset.Cylinderflowdataset import cylinderflowdatasetLSTM
from parsecylinderflow import parse_args
...
dataset_train = cylinderflowdatasetLSTM(args.data_pth, train=True, train_ratio=0.8, random_points=args.random,
                                   num_points=args.num_points)
dataset_test = cylinderflowdatasetLSTM(args.data_pth, train=False, train_ratio=0.8, random_points=args.random,
                                  num_points=args.num_points)
