...
from parsercylinder_flow import parse_args
...
train_dataset = CylinderDatasetLSTMBeta(data_path=args.data_pth , train=True, slice_lengths=[2, 5, 10, 20, 30, 50, 100, 383,500,1000,1200,1513])
...
def test():
    ...
    with torch.no_grad():
        ...
        for inputs, outputs in testloader:
            ...
            pre_reshaped = pre.view(1, 51, 384, 199)
            outputs_reshaped = outputs.view(1, 51, 384, 199)
