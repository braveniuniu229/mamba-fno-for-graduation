import argparse
def parse_args():
    parser = argparse.ArgumentParser(description='NOAA')
    ...
    parser.add_argument('--data_pth', type=str, default="../data/noaa.npy")
    ...
    parser.add_argument('--modes1', type=int, default=80)
