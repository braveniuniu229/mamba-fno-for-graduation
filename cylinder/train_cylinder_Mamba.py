...
file_mid = os.path.join(f"./{args.arch}_lr_{args.lr}_blocks_{args.num_blocks}", file_in)
...
def train():
    ...
    net = MambaModel(num_blocks=args.num_blocks,
                     d_model=args.d_model,
                     d_model_out=args.d_model_out,
                     d_state=args.d_state,
                     d_conv=args.d_conv,
                     expand=args.expand).to(device)
